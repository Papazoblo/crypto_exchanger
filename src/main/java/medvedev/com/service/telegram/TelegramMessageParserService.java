...
import medvedev.com.service.telegram.handler.ChangeInviolableResidueHandler;
import medvedev.com.service.telegram.handler.ChangeMinutesCountWithoutExchangeHandler;
import medvedev.com.service.telegram.handler.ChangePricePercentDifferenceHandler;
import medvedev.com.service.telegram.handler.CurrentBalanceHandler;
import medvedev.com.service.telegram.handler.CurrentPriceHandler;
import medvedev.com.service.telegram.handler.IncorrectCommandHandler;
import medvedev.com.service.telegram.handler.LaunchSystemHandler;
import medvedev.com.service.telegram.handler.NotAuthenticatedCommandHandler;
import medvedev.com.service.telegram.handler.StopSystemHandler;
    ...
    private BaseHandler getHandlerForAuthenticated(String commandLine) {
        ...
        switch (command) {
            ...
            case "/stopped":
                ...
                break;
            case "/balance":
                handler = new CurrentBalanceHandler(binanceClientService);
                break;
            case "/price":
                handler = new CurrentPriceHandler(binanceClientService);
                break;
            case "/cryptfiat":
            case "/fiatcrypt":
